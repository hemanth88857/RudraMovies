...
class TopRatedViewController: UIViewController {
    ...
    @IBOutlet weak var topRatdCmgCV: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        topRatdCmgCV.delegate = self
        topRatdCmgCV.dataSource = self
...
//    func startTimer() {
//
//        Timer.scheduledTimer(timeInterval: 3.0, target: self, selector: #selector(TopRatedViewController.scrollToNextCell), userInfo: nil, repeats: true);
//
//
//    }
//
...
extension TopRatedViewController : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == pagingCV {
            ...
            cell?.TPpagingImg.sd_setImage(with: URL(string: imgArr[indexPath.row]))
            ...
            let cell = topRatdCmgCV.dequeueReusableCell(withReuseIdentifier: "HomeCollectionViewCell", for: indexPath) as? HomeCollectionViewCell
